	   ...
	   <c:set  var="product_total_count" value="${product_count+1 }" />
        <div class="item">
          <div class="product_image">
			...
			<a id="wish" href=""><img width="40"alt="찜"src="https://iconmonstr.com/wp-content/g/gd/makefg.php?i=../releases/preview/2012/png/iconmonstr-favorite-13.png&r=0&g=0&b=0"></a>
   		</div>
		<div class="product_description">
	        <img alt="" src="https://pbs.twimg.com/profile_images/1553406441838456832/Qt18nVK8_400x400.jpg">					
  		    <h2><a href="${contextPath}/product/productDetail.do?product_id=${item.product_id}">${item.product_name }</a></h2>
<!-- 사업장관리 페이지로 이동 -->
            <h3><a href="${contextPath}/product/productDetail.do?product_id=${item.product_id}">${item.center_name }</a></h3>
		</div>
