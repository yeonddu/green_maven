package com.myspring.pro30.product.controller;
...
import com.myspring.pro30.product.service.ProductService;
...
public class ProductControllerImpl implements ProductController {
	...
	@RequestMapping(value="/productList.do" ,method = RequestMethod.GET)
		public ModelAndView sortByProduct(@RequestParam("productSort") String productSort, HttpServletRequest request, HttpServletResponse response) throws Exception{
		String viewName=(String)request.getAttribute("viewName");
		List<ProductVO> productList=productService.sortByProduct(productSort);
