...
<body>
	...
	<tr>
		<td width="150" align="center" bgcolor="#DED6F0">글번호</td>
		<td>
	...
	<tr>
		<td width="150" align="center" bgcolor="#DED6F0">작성자 아이디</td>
		<td><input type="text" value="${article.id}" name="writer" disabled/></td>
	</tr>
	<tr>
		<td width="150" align="center" bgcolor="#DED6F0">제목</td>
		<td><input type="text" value="${article.title}" name="title" id="i_title" disabled/></td>
	</tr>
	<tr>
		<td width="150" align="center" bgcolor="#DED6F0">내용</td>
	...
	<tr>
		<td width="150" align="center" bgcolor="#DED6F0" rowspan="2">이미지</td>
		<td>
	...
	<tr>
		<td width="150" align="center" bgcolor="#DED6F0">등록일자</td>
