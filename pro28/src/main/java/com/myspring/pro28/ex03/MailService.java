 ...
 * MimeMessage message = mailSender.createMimeMessage(); try { MimeMessageHelper
 * messageHelper = new MimeMessageHelper(message, true, "utf-8");
 * messageHelper.setFrom("yeonsu06@naver.com","¼Û¿¬¼ö");
 * messageHelper.setSubject(subject); messageHelper.setTo(to);
 * messageHelper.setText(body); mailSender.send(message); } catch(Exception e) {
 * e.printStackTrace(); } }
 * 
